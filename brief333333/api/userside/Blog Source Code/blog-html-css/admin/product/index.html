...
<html lang="en">
    ...
    <body>
        <header>
            <div class="logo">
                <h1 class="logo-text"><span>Velvet</span>Strides</h1>
            </div>
        ...
        <div class="admin-wrapper">
            ...
            <div class="left-sidebar">
                <ul>
                    ...
                    <li><a href="../Salls/index.html">Manage Salls </a></li>
            ...
            <div class="admin-content">
                <div class="button-group">
                    ...
                    <a href="index.html" class="btn btn-big">Manage Product</a>
                </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Awa</td>
                                <td>Awa</td>
                               <td> <img  src="/Blog Source Code/blog-html-css/images/image1.jpeg" class="imageshoes"></td> 
